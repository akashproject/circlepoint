...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppAppRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    */
    ...
    var routes = [{
      ...
      loadChildren: function loadChildren() {
        return __webpack_require__.e(
        /*! import() | pages-verify-otp-verify-otp-module */
        "pages-verify-otp-verify-otp-module").then(__webpack_require__.bind(null,
        /*! ./pages/verify-otp/verify-otp.module */
        "./src/app/pages/verify-otp/verify-otp.module.ts")).then(function (m) {
  ...
  function srcAppAppComponentScss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "@charset \"UTF-8\";\n/*\n  Authors : initappz (Rahul Jograna)\n  Website : https://initappz.com/\n  App Name : ionic 5 groceryee app\n  Created : 10-Sep-2020\n  This App Template Source code is licensed as per the\n  terms found in the Website https://initappz.com/license\n  Copyright and Good Faith Purchasers © 2020-present initappz.\n*/\nion-menu ion-content {\n  --background: var(--ion-item-background, var(--ion-background-color, #fff));\n}\n.infoSection {\n  background: var(--ion-color-primary);\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  align-items: center;\n  padding-top: 50px;\n}\n.infoSection .userPhoto {\n  width: 80px;\n  margin: 20px 0px;\n}\n.infoSection .userName {\n  margin: 0px;\n  padding: 0px;\n  font-size: 1.5rem;\n  font-weight: 500;\n  color: white;\n  margin-bottom: 20px;\n}\n.version {\n  margin: 0px;\n  padding: 0px;\n  font-size: 1rem;\n  font-weight: 500;\n  color: black;\n  margin-bottom: 25px;\n  text-align: center;\n  position: absolute;\n  bottom: 0px;\n  transform: translate(-50%, -50%);\n  left: 50%;\n}\nion-menu.md ion-note {\n  margin-bottom: 30px;\n}\nion-menu.md ion-list-header,\nion-menu.md ion-note {\n  padding-left: 10px;\n}\nion-menu.md ion-list#inbox-list ion-list-header {\n  font-size: 22px;\n  font-weight: 600;\n  min-height: 20px;\n}\nion-menu.md ion-list#labels-list ion-list-header {\n  font-size: 16px;\n  margin-bottom: 18px;\n  color: #757575;\n  min-height: 26px;\n}\nion-menu.md ion-item {\n  --padding-start: 10px;\n  --padding-end: 10px;\n  border-radius: 4px;\n}\nion-menu.md ion-item.selected {\n  --background: rgba(var(--ion-color-primary-rgb), 0.14);\n}\nion-menu.md ion-item.selected ion-icon {\n  color: var(--ion-color-primary);\n}\nion-menu.md ion-item ion-icon {\n  color: black;\n}\nion-menu.ios ion-content {\n  --padding-bottom: 20px;\n}\nion-menu.ios ion-note {\n  line-height: 24px;\n  margin-bottom: 20px;\n}\nion-item {\n  border-bottom: 1px solid lightgray;\n  --padding-start:30px !important;\n  --min-height: 60px !important;\n}\n.filterItems ion-item {\n  border-bottom: none !important;\n}\nion-menu.ios ion-item {\n  --padding-start: 16px;\n  --padding-end: 16px;\n  --min-height: 50px;\n}\nion-menu.ios ion-item.selected ion-icon {\n  color: var(--ion-color-primary);\n}\nion-menu.ios ion-item ion-icon {\n  font-size: 24px;\n}\nion-menu.ios ion-list#labels-list ion-list-header {\n  margin-bottom: 8px;\n}\nion-menu.ios ion-list-header,\nion-menu.ios ion-note {\n  padding-left: 16px;\n  padding-right: 16px;\n}\nion-menu.ios ion-note {\n  margin-bottom: 8px;\n}\nion-note {\n  display: inline-block;\n  font-size: 16px;\n  color: var(--ion-color-medium-shade);\n}\nion-item.selected {\n  --color: var(--ion-color-primary) ;\n}\n.imgs {\n  height: 20px;\n  width: 20px;\n  margin-right: 10px;\n}\n.menu_user_image {\n  height: 90px;\n  width: 90px;\n  background-position: center;\n  background-repeat: no-repeat;\n  background-size: cover;\n  border-radius: 50%;\n  margin: auto;\n}\n.username {\n  margin-top: 20px;\n  font-weight: 600;\n  display: block;\n  text-align: center;\n  font-size: 20px;\n}\n.email {\n  margin-top: 5px;\n  display: block;\n  text-align: center;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
  ...
  function srcAppAppComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    */
    ...
    var AppComponent = /*#__PURE__*/function () {
      function AppComponent(platform, splashScreen, statusBar, navCtrl, //private oneSignal: OneSignal,
      api, util, cart, router, menuCtrl) {
        ...
        console.log(moment__WEBPACK_IMPORTED_MODULE_8__().format("lll"));
      }
        ...
        value: function initializeApp() {
          ...
          this.platform.ready().then(function () {
            ...
            if (uid && uid !== null && uid !== "null") {
              ...
              _this.api.post("users/getById", _param).subscribe(function (data) {
                console.log("user info=>", data);
              ...
              _this.api.post("favourite/getByUid", _param).subscribe(function (data) {
    ...
    }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_2__["Platform"], _ionic_native_splash_screen_ngx__WEBPACK_IMPORTED_MODULE_3__["SplashScreen"], _ionic_native_status_bar_ngx__WEBPACK_IMPORTED_MODULE_4__["StatusBar"], _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["NavController"], _services_api_service__WEBPACK_IMPORTED_MODULE_5__["ApiService"], _services_util_service__WEBPACK_IMPORTED_MODULE_6__["UtilService"], _services_cart_service__WEBPACK_IMPORTED_MODULE_7__["CartService"], _angular_router__WEBPACK_IMPORTED_MODULE_9__["Router"], _ionic_angular__WEBPACK_IMPORTED_MODULE_2__["MenuController"]])], AppComponent);
    /***/
  },
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _pages_store_rating_store_rating_module__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(
    /*! ./pages/store-rating/store-rating.module */
    "./src/app/pages/store-rating/store-rating.module.ts");
    /* harmony import */


    var _pages_product_rating_product_rating_module__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(
    /*! ./pages/product-rating/product-rating.module */
    "./src/app/pages/product-rating/product-rating.module.ts");
    /* harmony import */


    var _pages_driver_rating_driver_rating_module__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(
    /*! ./pages/driver-rating/driver-rating.module */
    ...
    var _pages_sort_sort_module__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(
    /*! ./pages/sort/sort.module */
    "./src/app/pages/sort/sort.module.ts");
    /* harmony import */


    var _pages_verify_verify_module__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(
    /*! ./pages/verify/verify.module */
    ...
    */
    ...
    AppModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
      ...
      entryComponents: [],
      imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_2__["BrowserModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"].forRoot(), _app_routing_module__WEBPACK_IMPORTED_MODULE_5__["AppRoutingModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_7__["HttpClientModule"], _pipes_pipe_module__WEBPACK_IMPORTED_MODULE_8__["PipeModule"], _ionic_storage__WEBPACK_IMPORTED_MODULE_14__["IonicStorageModule"].forRoot(), _pages_store_rating_store_rating_module__WEBPACK_IMPORTED_MODULE_19__["StoreRatingPageModule"], _pages_product_rating_product_rating_module__WEBPACK_IMPORTED_MODULE_20__["ProductRatingPageModule"], _pages_driver_rating_driver_rating_module__WEBPACK_IMPORTED_MODULE_21__["DriverRatingPageModule"], _pages_verify_verify_module__WEBPACK_IMPORTED_MODULE_24__["VerifyPageModule"], _pages_sort_sort_module__WEBPACK_IMPORTED_MODULE_23__["SortPageModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_22__["FormsModule"]],
      providers: [_ionic_native_status_bar_ngx__WEBPACK_IMPORTED_MODULE_13__["StatusBar"], _ionic_native_splash_screen_ngx__WEBPACK_IMPORTED_MODULE_12__["SplashScreen"], _ionic_native_http_ngx__WEBPACK_IMPORTED_MODULE_11__["HTTP"], //OneSignal,
      _ionic_native_camera_ngx__WEBPACK_IMPORTED_MODULE_9__["Camera"], _ionic_native_file_transfer_ngx__WEBPACK_IMPORTED_MODULE_10__["FileTransferObject"], _ionic_native_android_permissions_ngx__WEBPACK_IMPORTED_MODULE_15__["AndroidPermissions"], _ionic_native_diagnostic_ngx__WEBPACK_IMPORTED_MODULE_16__["Diagnostic"], _ionic_native_geolocation_ngx__WEBPACK_IMPORTED_MODULE_17__["Geolocation"], _ionic_native_in_app_browser_ngx__WEBPACK_IMPORTED_MODULE_18__["InAppBrowser"], {
  ...
  function srcAppPagesDriverRatingDriverRatingPageScss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "@charset \"UTF-8\";\n/*\n  Authors : initappz (Rahul Jograna)\n  Website : https://initappz.com/\n  App Name : ionic 5 groceryee app\n  Created : 10-Sep-2020\n  This App Template Source code is licensed as per the\n  terms found in the Website https://initappz.com/license\n  Copyright and Good Faith Purchasers © 2020-present initappz.\n*/\n.main_content_div {\n  padding: 20px;\n}\n.main_content_div .main_div {\n  display: flex;\n  flex-direction: column;\n  justify-content: space-between;\n}\n.main_content_div .user_img {\n  height: 90px;\n  width: 90px;\n  border-radius: 50%;\n  border: 3px solid var(--ion-color-primary);\n  margin: auto;\n  margin-bottom: 30px;\n  background-position: center;\n  background-repeat: no-repeat;\n  background-size: cover;\n  min-width: 90px;\n  position: relative;\n}\n.main_content_div .rattingBtns {\n  margin: 20px 0px;\n}\n.main_content_div .name {\n  border-radius: 5px;\n  box-shadow: 0px 0px 20px -3px rgba(30, 98, 255, 0.3);\n  display: flex;\n  flex-direction: row;\n  padding: 10px;\n  justify-content: flex-start;\n  position: relative;\n  margin-bottom: 20px;\n}\n.main_content_div .name .image_div {\n  width: 20px;\n  position: relative;\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  align-items: center;\n}\n.main_content_div .name .icn {\n  max-width: 15px;\n  position: absolute;\n  top: 50%;\n  transform: translateY(-50%);\n}\n.main_content_div .name .content_div {\n  position: relative;\n  display: flex;\n  flex-flow: row;\n  margin-left: 15px;\n}\n.main_content_div .name .content_div span {\n  font-size: 11px;\n  color: #8992AA;\n  padding-top: 5px;\n}\n.main_content_div .name .content_div ion-input {\n  font-size: 11px;\n  color: #454D62;\n}\n.main_content_div .btn_div {\n  display: block;\n  width: 100%;\n  text-align: center;\n}\n.main_content_div ion-button {\n  --background: var(--ion-color-primary);\n  --border-radius: 3px;\n  --color: white;\n  font-weight: bold;\n  font-size: 12px;\n  height: 40px;\n  width: 150px;\n  text-transform: capitalize;\n  --background-activated: rgba(159, 201, 165, 0.5);\n  --color-actived: white;\n}\n.main_content_div ion-button .logout_icon {\n  width: 12px;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
    ...
    var DriverRatingPage = /*#__PURE__*/function () {
      function DriverRatingPage(navParam, modalCtrl, util, api) {
        ...
        this.api.post('rating/getFromCount', param).subscribe(function (data) {
          ...
          console.log('total', _this2.total);
        }, function (error) {
          console.log(error);
      ...
      _createClass(DriverRatingPage, [{
        ...
        value: function submit() {
          ...
          this.api.post('rating/save', param).subscribe(function (data) {
            ...
            if (data && data.status === 200) {
              _this3.util.showToast(_this3.util.getString('Rating added'), 'success', 'bottom');

              _this3.close('success');
            } else {
  ...
  function srcAppPagesProductRatingProductRatingPageScss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "@charset \"UTF-8\";\n/*\n  Authors : initappz (Rahul Jograna)\n  Website : https://initappz.com/\n  App Name : ionic 5 groceryee app\n  Created : 10-Sep-2020\n  This App Template Source code is licensed as per the\n  terms found in the Website https://initappz.com/license\n  Copyright and Good Faith Purchasers © 2020-present initappz.\n*/\n.main_content_div {\n  padding: 20px;\n}\n.main_content_div .main_div {\n  display: flex;\n  flex-direction: column;\n  justify-content: space-between;\n}\n.main_content_div .user_img {\n  height: 90px;\n  width: 90px;\n  border-radius: 50%;\n  border: 3px solid var(--ion-color-primary);\n  margin: auto;\n  margin-bottom: 30px;\n  background-position: center;\n  background-repeat: no-repeat;\n  background-size: cover;\n  min-width: 90px;\n  position: relative;\n}\n.main_content_div .rattingBtns {\n  margin: 20px 0px;\n}\n.main_content_div .name {\n  border-radius: 5px;\n  box-shadow: 0px 0px 20px -3px rgba(30, 98, 255, 0.3);\n  display: flex;\n  flex-direction: row;\n  padding: 10px;\n  justify-content: flex-start;\n  position: relative;\n  margin-bottom: 20px;\n}\n.main_content_div .name .image_div {\n  width: 20px;\n  position: relative;\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  align-items: center;\n}\n.main_content_div .name .icn {\n  max-width: 15px;\n  position: absolute;\n  top: 50%;\n  transform: translateY(-50%);\n}\n.main_content_div .name .content_div {\n  position: relative;\n  display: flex;\n  flex-flow: row;\n  margin-left: 15px;\n}\n.main_content_div .name .content_div span {\n  font-size: 11px;\n  color: #8992AA;\n  padding-top: 5px;\n}\n.main_content_div .name .content_div ion-input {\n  font-size: 11px;\n  color: #454D62;\n}\n.main_content_div .btn_div {\n  display: block;\n  width: 100%;\n  text-align: center;\n}\n.main_content_div ion-button {\n  --background: var(--ion-color-primary);\n  --border-radius: 3px;\n  --color: white;\n  font-weight: bold;\n  font-size: 12px;\n  height: 40px;\n  width: 150px;\n  text-transform: capitalize;\n  --background-activated: rgba(159, 201, 165, 0.5);\n  --color-actived: white;\n}\n.main_content_div ion-button .logout_icon {\n  width: 12px;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
    ...
    var ProductRatingPage = /*#__PURE__*/function () {
      function ProductRatingPage(navParam, modalCtrl, util, api) {
        ...
        this.api.post('rating/getFromCount', param).subscribe(function (data) {
          ...
          console.log('total', _this4.total);
        }, function (error) {
          console.log(error);
      ...
      _createClass(ProductRatingPage, [{
        ...
        value: function submit() {
          ...
          this.api.post('rating/save', param).subscribe(function (data) {
            ...
            if (data && data.status === 200) {
              _this5.util.showToast('Rating added', 'success', 'bottom');

              var storeParam = {
                id: _this5.id,
                total_rating: _this5.total + 1,
                rating: storeRating
              };

              _this5.api.post('products/editList', storeParam).subscribe(function (stores) {
                console.log('products edit done', stores);
              }, function (error) {
                console.log(error);
              });

              _this5.close('success');
            } else {
  ...
  function srcAppPagesStoreRatingStoreRatingPageScss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = "@charset \"UTF-8\";\n/*\n  Authors : initappz (Rahul Jograna)\n  Website : https://initappz.com/\n  App Name : ionic 5 groceryee app\n  Created : 10-Sep-2020\n  This App Template Source code is licensed as per the\n  terms found in the Website https://initappz.com/license\n  Copyright and Good Faith Purchasers © 2020-present initappz.\n*/\n.main_content_div {\n  padding: 20px;\n}\n.main_content_div .main_div {\n  display: flex;\n  flex-direction: column;\n  justify-content: space-between;\n}\n.main_content_div .user_img {\n  height: 90px;\n  width: 90px;\n  border-radius: 50%;\n  border: 3px solid var(--ion-color-primary);\n  margin: auto;\n  margin-bottom: 30px;\n  background-position: center;\n  background-repeat: no-repeat;\n  background-size: cover;\n  min-width: 90px;\n  position: relative;\n}\n.main_content_div .rattingBtns {\n  margin: 20px 0px;\n}\n.main_content_div .name {\n  border-radius: 5px;\n  box-shadow: 0px 0px 20px -3px rgba(30, 98, 255, 0.3);\n  display: flex;\n  flex-direction: row;\n  padding: 10px;\n  justify-content: flex-start;\n  position: relative;\n  margin-bottom: 20px;\n}\n.main_content_div .name .image_div {\n  width: 20px;\n  position: relative;\n  display: flex;\n  flex-direction: column;\n  justify-content: center;\n  align-items: center;\n}\n.main_content_div .name .icn {\n  max-width: 15px;\n  position: absolute;\n  top: 50%;\n  transform: translateY(-50%);\n}\n.main_content_div .name .content_div {\n  position: relative;\n  display: flex;\n  flex-flow: row;\n  margin-left: 15px;\n}\n.main_content_div .name .content_div span {\n  font-size: 11px;\n  color: #8992AA;\n  padding-top: 5px;\n}\n.main_content_div .name .content_div ion-input {\n  font-size: 11px;\n  color: #454D62;\n}\n.main_content_div .btn_div {\n  display: block;\n  width: 100%;\n  text-align: center;\n}\n.main_content_div ion-button {\n  --background: var(--ion-color-primary);\n  --border-radius: 3px;\n  --color: white;\n  font-weight: bold;\n  font-size: 12px;\n  height: 40px;\n  width: 150px;\n  text-transform: capitalize;\n  --background-activated: rgba(159, 201, 165, 0.5);\n  --color-actived: white;\n}\n.main_content_div ion-button .logout_icon {\n  width: 12px;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
    ...
    var StoreRatingPage = /*#__PURE__*/function () {
      function StoreRatingPage(navParam, modalCtrl, util, api) {
        ...
        this.api.post('rating/getFromCount', param).subscribe(function (data) {
          ...
          if (data && data.status === 200) {
            if (data && data.data && data.data.total) {
              _this6.total = data.data.total;

              if (data.data.rating) {
                var rats = data.data.rating;
                console.log(rats.split(','));
                _this6.rating = rats.split(',');
              } else {
                _this6.rating = [];
              }
            } else {
          ...
          console.log('total', _this6.total);
        }, function (error) {
          console.log(error);
      ...
      _createClass(StoreRatingPage, [{
        ...
        value: function submit() {
          ...
          this.api.post('rating/save', param).subscribe(function (data) {
            ...
            if (data && data.status === 200) {
              _this7.util.showToast(_this7.util.getString('Rating added'), 'success', 'bottom');

              var storeParam = {
                id: _this7.id,
                total_rating: _this7.total + 1,
                rating: storeRating
              };

              _this7.api.post('stores/editByUid', storeParam).subscribe(function (stores) {
                console.log('store edit done', stores);
              }, function (error) {
                console.log(error);
              });

              _this7.close('success');
            } else {
  ...
  function srcAppPagesVerifyVerifyModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*! ./verify.page */
    "./src/app/pages/verify/verify.page.ts"); //import { NgOtpInputModule } from "ng-otp-input";
  ...
  function srcAppPagesVerifyVerifyPageScss(module, __webpack_exports__, __webpack_require__) {
    ...
    __webpack_exports__["default"] = ".otpContainer {\n  margin-top: 50%;\n}\n.otpContainer .headerText {\n  text-align: center;\n  font-weight: bolder;\n  font-size: 2rem;\n}\n.otpContainer .subTitleText {\n  text-align: center;\n  font-weight: bold;\n  color: gray;\n  font-size: 1rem;\n}\n.otpContainer .otpInputs {\n  display: flex;\n  justify-content: center;\n  margin-top: 50px;\n}\n.otpContainer .btn_class {\n  color: white;\n  margin: 30px 50px;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
          ...
          if (this.userCode) {
            ...
            this.api.post('users/verifyOTP', param).subscribe(function (data) {
              ...
              if (data && data.status === 200) {
                ...
                _this10.api.post('users/edit_profile', params).subscribe(function (data) {
                  _this10.util.hide();
                  ...
                  localStorage.setItem('uid', _this10.uid);

                  _this10.navCtrl.navigateRoot(['']);
                }, function (error) {
                  _this10.util.hide();
                ...
                if (data && data.status === 500 && data.data && data.data.message) {
                  _this10.util.errorToast(data.data.message);
    ...
    */
      ...
      _createClass(ApiService, [{
        ...
        value: function createOrderNotification(stores) {
          ...
          ids.forEach(function (element) {
            apiCalls.push(_this11.sendNotification("You have received new order", "New Order Received", element));
          });
        ...
        key: "twilloPostSms",
        value: function twilloPostSms(url, body) {
          var absUrl = "https://api.circlepoint.in/index.php/";
          var authorizationData = "Basic " + btoa("ACf22e2074a2b2e49c8ab1fcc1b55d6502" + ":" + "bf42fc20ebaa6c0f07f0bd49f6c8a689==");
          var header = {
            headers: new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpHeaders"]().set("Content-Type", "application/x-www-form-urlencoded").set("Authorization", authorizationData).set("Access-Control-Allow-Origin", "*")
          };
          var order = this.JSON_to_URLEncoded(body);
          console.log(order);
    ...
    ApiService.ctorParameters = function () {
      return [{
        ...
        type: _ionic_native_http_ngx__WEBPACK_IMPORTED_MODULE_4__["HTTP"] // public cart: CartService
    ...
    ApiService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
      providedIn: "root"
    }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"], _ionic_native_http_ngx__WEBPACK_IMPORTED_MODULE_4__["HTTP"] // public cart: CartService
    ])], ApiService);
    /***/
  },
        ...
        this.util.getKeys('cart').then(function (data) {
          if (data && data !== null && data !== 'null') {
            ...
            if (userCart && userCart.length > 0) {
              _this12.cart = userCart;
              _this12.itemId = _toConsumableArray(new Set(_this12.cart.map(function (item) {
                return item.id;
              })));
      ...
      _createClass(CartService, [{
        ...
        value: function calcuate() {
          ...
          if (this.stores && this.stores.length && this.deliveryAddress && this.deliveryAt === 'home') {
            ...
            setTimeout(function () {
              console.log('free', _this13.freeShipping);
              console.log('totalprice', _this13.totalPrice);

              if (_this13.freeShipping > _this13.totalPrice) {
                if (_this13.shipping === 'km') {
                  var distancePricer = totalKM * _this13.shippingPrice;
                  console.log('====================> KM price', distancePricer);
                  _this13.deliveryPrice = Math.floor(distancePricer).toFixed(2);

                  if (!_this13.discount || _this13.discount === null) {
                    _this13.discount = 0;
                  }

                  _this13.grandTotal = _this13.totalPrice - parseFloat(_this13.discount) + _this13.orderTax + distancePricer;
                  _this13.grandTotal = parseFloat(_this13.grandTotal).toFixed(2);
                  console.log('grand total===>>', _this13.grandTotal); // console.log('deliveryeeeeeeeee', this.deliveryPrice);
                } else {
                  _this13.deliveryPrice = _this13.shippingPrice;
                  console.log('shippppppppp=-======0-00-=-=', _this13.shippingPrice);

                  if (!_this13.discount || _this13.discount === null) {
                    _this13.discount = 0;
                  }

                  _this13.grandTotal = _this13.totalPrice - parseFloat(_this13.discount) + _this13.orderTax + _this13.shippingPrice;
                  _this13.grandTotal = parseFloat(_this13.grandTotal).toFixed(2);
                  console.log('grand total===>>', _this13.grandTotal);
                }
              } else {
                _this13.deliveryPrice = 0; // this.grandTotal = this.totalPrice + this.orderTax;

                console.log('discount', _this13.discount);

                if (!_this13.discount || _this13.discount === null) {
                  _this13.discount = 0;
                }

                console.log('order tax', _this13.orderTax);
                _this13.grandTotal = _this13.totalPrice - parseFloat(_this13.discount) + _this13.orderTax;
                _this13.grandTotal = parseFloat(_this13.grandTotal).toFixed(2);
                console.log('grand total===>>', _this13.grandTotal);
              }
            }, 1000);
        ...
        value: function createBulkOrder() {
          ...
          ids.forEach(function (element, index) {
            _this14.cart.forEach(function (cart) {
      ...
      _createClass(UtilService, [{
        ...
        value: function getKeys(key) {
          ...
          return new Promise(function (resolve, reject) {
            _this15.storage.get(key).then(function (data) {
              resolve(data);
        ...
        value: function setKeys(key, value) {
          ...
          return new Promise(function (resolve, reject) {
            _this16.storage.set(key, value).then(function (data) {
              resolve(data);
            })["catch"](function (error) {
              reject(error);
            });
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! E:\Ionic\circlepoint-old\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
