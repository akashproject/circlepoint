  ...
  function srcAppPagesHomeHomePageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    */
    ...
    var HomePage = /*#__PURE__*/function () {
      function HomePage(util, router, api, cart, chMod, iab, alertCtrl, actionSheetController, camera, authGuard) {
        var _this = this;
      ...
      _createClass(HomePage, [{
        ...
        key: "checkloginStatusBeforeUpload",
        value: function checkloginStatusBeforeUpload(item) {
        ...
        value: function search(event) {
          ...
          if (event && event !== "") {
            ...
            this.api.post("products/getSearchItems", param).subscribe(function (data) {
              ...
              setTimeout(function () {
                _this8.productsRecordStatus = true;
              }, 2000);
            }, function (error) {
        ...
        value: function upload(type) {
          ...
          try {
            ...
            this.camera.getPicture(options).then(function (url) {
              ...
              _this10.api.nativePost("users/upload_file_order", alpha).then(function (data) {
                _this10.util.hide(); // Save to Prescripe
                ...
                _this10.api.post("prescription/save", param).subscribe(function (update) {
                  _this10.util.hide();
    ...
    }), Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"])("design:paramtypes", [_services_util_service__WEBPACK_IMPORTED_MODULE_2__["UtilService"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"], _services_api_service__WEBPACK_IMPORTED_MODULE_4__["ApiService"], _services_cart_service__WEBPACK_IMPORTED_MODULE_5__["CartService"], _angular_core__WEBPACK_IMPORTED_MODULE_1__["ChangeDetectorRef"], _ionic_native_in_app_browser_ngx__WEBPACK_IMPORTED_MODULE_7__["InAppBrowser"], _ionic_angular__WEBPACK_IMPORTED_MODULE_8__["AlertController"], _ionic_angular__WEBPACK_IMPORTED_MODULE_8__["ActionSheetController"], _ionic_native_camera_ngx__WEBPACK_IMPORTED_MODULE_9__["Camera"], _guard_auth_guard__WEBPACK_IMPORTED_MODULE_10__["AuthGuard"]])], HomePage);
    /***/
  }
}]);
